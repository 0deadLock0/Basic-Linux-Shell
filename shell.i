...
int parse_command(char[],char[][1000]);
void execute_command(char[][1000],int);
...
void print_strings(char*[1000],int);
void print_String(char[]);
void print_Strings(char[][1000],int);

void run_cd(char[][1000],int);
void run_echo(char[][1000],int);
void run_history(char[][1000],int);
void run_pwd(char[][1000],int);
void run_exit(char[][1000],int);
void run_ls(char[][1000],int);
void run_cat(char[][1000],int);
void run_date(char[][1000],int);
void run_rm(char[][1000],int);
void run_mkdir(char[][1000],int);

void (*run_command[])(char[][1000],int) =
{
 run_cd,
 run_echo,
 run_history,
...
char AbsolutePath[1000]= "/home/deadlocks/Codes/assignment1/1.2";

int main()
{
 if(getcwd(AbsolutePath,sizeof(AbsolutePath))==
# 61 "shell.c" 3 4
                                              ((void *)0)
# 61 "shell.c"
                                                  )
...
void print_strings(char* strings[1000],int size)
{
 printf("Strings-\n");
...
int parse_command(char command[],char tokens[][1000])
{
 trim_ends(command);
 int quotesFlag=0;
 int i=0,j=0;
...
void execute_command(char tokens[][1000],int size)
{
...
void run_cd(char tokens[][1000],int size)
{
 if(size>2)
...
void run_echo(char tokens[][1000],int size)
{
 if(size==1)
  printf("\n");
...
void run_history(char tokens[][1000],int size)
{
 if(size==1)
 {
  fseek(historyFile,
...
void run_pwd(char tokens[][1000],int size)
{
 if(size>2)
  printf("Excess of arguments\n");
...
void run_exit(char tokens[][1000],int size)
{
...
void run_ls(char tokens[][1000],int size)
{
 char** modifiedTokens=(char**)calloc(size+1,1000);
...
void run_cat(char tokens[][1000],int size)
{
 char** modifiedTokens=(char**)calloc(size+1,1000);
 char absolutePath[1000];
 strcpy(absolutePath,AbsolutePath);
...
void run_date(char tokens[][1000],int size)
{
 char** modifiedTokens=(char**)calloc(size+1,1000);
 char absolutePath[1000];
 strcpy(absolutePath,AbsolutePath);
...
void run_rm(char tokens[][1000],int size)
{
 char** modifiedTokens=(char**)calloc(size+1,1000);
 char absolutePath[1000];
 strcpy(absolutePath,AbsolutePath);
...
void run_mkdir(char tokens[][1000],int size)
{
 char** modifiedTokens=(char**)calloc(size+1,1000);
 char absolutePath[1000];
 strcpy(absolutePath,AbsolutePath);
